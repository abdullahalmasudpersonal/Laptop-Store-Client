        ...
        <div className='bestsellinglaptop-bg'>
            <div className='container py-5'>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h3 class="card-title best-selling-title">Best Selling Laptop</h3>
                        <p class="card-title "><small className='best-selling-laptop'>Lenovo IdeaPad-3 11-Chromebook</small></p>
